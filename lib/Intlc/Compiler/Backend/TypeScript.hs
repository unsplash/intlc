...
module Intlc.Compiler.Backend.TypeScript (compileNamedExport, compileReactImport) where
...
compileReactImport :: () -> Text 
compileReactImport = pure "import * as React from 'types/React'"
